                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-4">
                        ...
                        <p class="text-center text-danger">${error}</p>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold text-white">Tài khoản</label>
                                <input type="text" name="id" value="${sessionScope.currentUser.id}" class="form-control" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold text-white">Mật khẩu hiện tại</label>
                            ...
                            <button class="btn btn-primary w-100 fw-bold btn-gradient">Xác nhận đổi</button>
                        </form>
                    </div>
                </div>
            </div>
